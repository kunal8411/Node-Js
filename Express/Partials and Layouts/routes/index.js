...
//if path come as localhost:8000/post then redirect our route to users folder inside routed 
router.use('/post',require('./post'));

//if path come as localhost:8000/like then redirect our route to users folder inside routed 
